	...
	public static void main(String[] args) {
		...
		for (int riga = 0; riga < 10; riga++) {
		    for (int col = 0; col < 10; col++) {
		        ...
		        // Imposta la lettera (se già la sai)
		        // bottone.setText("A"); 
		        
		        // 2. Controlla se questa cella è l'inizio di una parola
		        // (Questo è solo un esempio, la tua logica sarà qui)
		        if (riga == 0 && col == 0) {
		        ...
		        // Aggiungi l'ActionListener e tutto il resto come facevi prima
		        // bottone.addActionListener(...); 

		        // 3. Aggiungi il bottone alla griglia e al pannello
		        gb[riga][col] = bottone;
		...
		dV.append("6. Muovere il primo passo\n");
		dV.append("7. Un motore che sfrutta due diverse fonti di alimentazione\n");
		dV.append("8. Olimpiadi Italiane d'Informatica\n");
		dV.append("9. Telecomunicazioni\n");
		dV.append("10. Nel pianoforte, vengono percosse dai martelletti\n");
		dV.append("11. Profondo rancore\n");
		dV.append("12. La sigla della provincia di Forlì\n");
		dV.append("13. Articolo in dialetto Romanesco\n");
		dV.append("14. Né tua, né sua\n");
		dV.append("15. Il simbolo chimico dell'Argon\n");
		
		dO.append("ORIZZONTALI:\n");
		dO.append("1. I popolari pantaloni da lavoro in tela blu\n");
		dO.append("2. Il contrario di 'bene'\n");
		dO.append("3. Parola chiave per un metodo senza 'return'\n");
		dO.append("4. Una cattiva abitudine difficile da estirpare\n");
		dO.append("5. Illumina molte vetrine dei negozi\n");
		dO.append("6. Dio dei morti nelll'antico egitto\n");
		dO.append("7. Uno dei tre stati della materia\n");
		dO.append("8. Dò fastidio, provoco nervosismo\n");
		dO.append("9. Azriel ssenza el\n");
		dO.append("10. Assistenza a lungo termine\n");
		dO.append("11. Affine allo Iodio\n");
		dO.append("12. Indica una contrapposizione\n");
		dO.append("13. Il re barbaro che pose fine all'Impero Romano d'Occidente\n");
		dO.append("14. Uno dei sette vizi capitali\n");
		dO.append("15. Il titolo che spetta a un medico\n");
		dO.append("16. Lo era, ad esempio, lo Zeppelin\n");
